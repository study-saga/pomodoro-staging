...
export const MusicPlayer = lazy(() => import('./music/MusicPlayer').then(m => ({ default: m.MusicPlayer })));

// Music Credits Modal - Music attribution modal
export const MusicCreditsModal = lazy(() => import('./settings/MusicCreditsModal').then(m => ({ default: m.MusicCreditsModal })));

// Ban Modal - User ban management interface
export const BanModal = lazy(() => import('./chat/BanModal').then(m => ({ default: m.BanModal })));
