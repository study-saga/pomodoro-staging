    ...
    >
      ...
      <div className="space-y-3">
        ...
        <select
          ...
          className="w-full bg-gray-700 text-white rounded-lg px-4 py-2.5 border border-gray-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition disabled:opacity-50"
        >
      ...
      {statusMessage && (
        <div
          ...
          `}
        >
          {statusMessage.type === 'success' && <Check className="w-5 h-5 text-green-400 mt-0.5" />}
          {statusMessage.type === 'error' && <AlertCircle className="w-5 h-5 text-red-400 mt-0.5" />}
          {statusMessage.type === 'info' && <AlertCircle className="w-5 h-5 text-blue-400 mt-0.5" />}
