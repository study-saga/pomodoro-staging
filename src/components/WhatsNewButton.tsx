    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          className={`backdrop-blur-md rounded-full text-white transition-colors bg-black/40 hover:bg-black/60 border border-white/10 z-40 flex items-center gap-2 ${
            isMobile ? 'p-2' : 'p-3'
          }`}
      ...
      <PopoverContent
        className="w-[calc(100vw-2rem)] sm:w-[380px] p-0 bg-gray-900 backdrop-blur-xl border border-white/10"
        align="end"
        sideOffset={8}
      >
