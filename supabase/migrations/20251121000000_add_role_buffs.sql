-- Add role buff tracking to completed_pomodoros table
-- Tracks critical success events for human role
...
-- Update atomic_save_completed_pomodoro function to support critical_success
