...
export function ChatContainer() {
  ...
  // Force desktop layout for Discord Activity
  // isMobile is already destructured at the top level but we ignore it for this view
    ...
    <>
      ...
      {!isExpanded && (
        <button
          ...
          className={`absolute bottom-24 left-4 z-40 transition-all duration-300 ease-out hover:scale-110 active:scale-95 ${isChatEnabled && !isBanned
      ...
      {isExpanded && (
        <div className={`absolute bottom-20 left-4 z-40 flex flex-col gap-1.5 w-[320px] max-w-[calc(100vw-2rem)] transition-all duration-300`}>
